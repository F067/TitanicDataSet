...
function Passenger(props) {
    ...
    const { filteredPassengers, isLoading, noResults } = props
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-around', alignItems: 'center' }}>
            {
                isLoading ? (
                    ...
                    : noResults ?
                        <span style={{ fontFamily: "sans-serif", fontSize: "30px", height: '600px', display: 'flex', alignItems: 'center' }}>No results found</span>
                        :
